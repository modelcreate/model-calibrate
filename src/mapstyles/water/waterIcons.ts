const squareSolid =
  '<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"  viewBox="0 0 448 512"><path fill="#1dbcec" d="M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48z"/></svg>';
const squareCross =
...
const circleSolid =
  '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle fill="#33d935" cx="50" cy="50" r="5"/></svg>';
const circleSolidOrange =
  '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle fill="#ff7f00" cx="50" cy="50" r="5"/></svg>';
