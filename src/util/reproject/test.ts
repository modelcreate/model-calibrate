...
const geoIn2: FeatureCollection<Geometries, Properties> = {
  ...
  features: [
    {
      type: "Feature",
      geometry: { type: "Point", coordinates: [429157, 623009] },
      properties: {
        table: "wn_node",
        node_id: "1234",
        totdemnd: 0.0,
    ...
    },
    {
      ...
      geometry: {
        type: "LineString",
        coordinates: [[429157, 623009], [429157, 623009]]
      },
      properties: {
        table: "wn_meter",
        us_node_id: "1234",
  ...
  features: [
    {
      ...
      geometry: {
        type: "Point",
        coordinates: [-1.5399906584608514, 55.50003197082179]
      },
      properties: {
        table: "wn_node",
        node_id: "1234",
    ...
    },
    {
      ...
      geometry: {
        type: "LineString",
        coordinates: [
          [-1.5399906584608514, 55.50003197082179],
          [-1.5399906584608514, 55.50003197082179]
        ]
      },
      properties: {
...
it("reprojects a feature", () => {
  ...
  const lineOut: Feature<Geometry> = {
    type: "Feature",
    geometry: {
      type: "LineString",
      coordinates: [
...
it("reprojects a feature and removes duplicate end point", () => {
  const lineIn: Feature<Geometry> = {
    ...
    geometry: {
      type: "LineString",
      coordinates: [[429157, 623009], [429157, 623009], [429157, 623009]]
    },
    properties: {}
  };
  const lineOut: Feature<Geometry> = {
